...
export class Microphone {
	...
	// Delegate to Device
	get context() { return this.#device.context; }
	get kind() { return this.#device.kind; }
	get enabled() { return this.#device.enabled; }
	set enabled(value: boolean) { this.#device.enabled = value; }
	get constraints() { return this.#device.constraints; }
	set constraints(value: MediaTrackConstraints | undefined) { this.#device.constraints = value; }
	get preferred() { return this.#device.preferred; }
	set preferred(value: string | undefined) { this.#device.preferred = value; }
	get activeDeviceId() { return this.#device.activeDeviceId; }
	set activeDeviceId(value: string | undefined) { this.#device.activeDeviceId = value; }
	get onTrackEnded() { return this.#device.onTrackEnded; }
	set onTrackEnded(value: ((reason: string) => void) | undefined) { this.#device.onTrackEnded = value; }
